...
\usepackage{ctex, amsmath, amsthm, graphicx, amsfonts, fancyhdr, ctable, pict2e, CJKulem, multirow}
...
\section{数学}
  ...
  \item Pick定理: 简单多边形, 不自交, 顶点如果全是整点. 则: $\frac{(\mbox{严格在多边形内部的整点数}\times 2+\mbox{在边上的整点数}-2)}{2}=\mbox{面积}$
